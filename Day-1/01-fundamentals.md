...
### Notes:
- Terraform applies API as code concept to achieve the infrastructure as code target.
- It uses HCL scripting that can talk with AWS/Azure/Open stack/GCP through their APIs.
